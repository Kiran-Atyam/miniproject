...
public class AdminController {
	...
	@GetMapping(value = "/getAllbook/{customerId}")
	...
	public List<TripBooking>f7(@PathVariable(name="customerid")int customerid,@PathVariable(name = "fromDate")@DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)LocalDateTime from,@PathVariable(name = "toDate")@DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)LocalDateTime to){
